...
#dat = np.load('unique_mgmno_sc.npy')
dat = np.load('unique_sc_mgmno.npy')
with open("unique_sc_mgmno_name_list", 'rb') as f:
    name_list = pickle.load(f)
#dat = np.load('supercell.npy')
comp_image_dict = {}
comp_dict = []
n_v_list =[]
n_o_list = []
...
#    with open('unique_mgmno_sc_comp_dict','w') as f:
with open('unique_sc_mgmno_comp_dict','wb') as f:
